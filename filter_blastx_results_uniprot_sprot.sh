...
goinfo="uniprot_swissprot_gene_GO.csv" # the name of a file containing genes and GO term info from your organism that you BLASTed against. We can get this from ENSEMBL, I will show you
...
seqkit grep -v -f uniprot_sprot_annotated_transcripts.txt zebrafish_unannotated_contigs.fa -o uniprot_sprot_unannotated_contigs.fa
...
seqkit grep -v -f uniprot_sprot_annotated_transcripts_chordates.txt zebrafish_unannotated_contigs.fa -o uniprot_sprot_chordates_unannotated_contigs.fa
